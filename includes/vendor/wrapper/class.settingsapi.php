		...
		switch ( $type ) {
		   ...
		   case 'editor':
			...
			break;
			 ...
			 case 'hidden_text':
			// default:
		  		echo '<input class="regular-text-hidden" type="hidden" id="'.$section.'[' . $id . ']" name="'.$section.'[' . $id . ']" placeholder="' . $std . '" value="' . esc_attr( $value ) . '" />';
		 		
		  		if ( $desc != '' )
		  			echo '</td></tr><tr valign="top"><td colspan="2"><br /><span class="description">' . $desc . '</span>';
